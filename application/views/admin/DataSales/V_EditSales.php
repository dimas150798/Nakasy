        ...
        <div class="menuatas">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-12 col-xl-auto mt-2">
                    <a class="btn buttonmenuatas" href="<?php echo base_url('admin/DataSales/C_DataSales') ?>"><img src="<?php echo base_url(); ?>vendor/bootstrap-icons/icons/backspace-fill.svg" alt="Bootstrap" ...> Kembali
                    </a>
                </div>
            </div>
        </div>
                            ...
                            <form method="POST" action="<?php echo base_url('admin/DataSales/C_EditSales/EditSalesSave') ?>">
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" class="form-control" name="nama_sales" id="nama_sales" value="<?php echo $data['nama_sales'] ?>" placeholder="Masukkan nama...">
                                        <div class="bg-danger">
