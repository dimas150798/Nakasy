...
class C_BelumLunas extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['BelumLunas']         = $this->M_BelumLunasUser->BelumLunas($Month, $Year, $LastDate, $area_1, $area_2, $area_3, $area_4, $area_5);
        $data['JumlahBelumLunas']   = $this->M_BelumLunasUser->JumlahBelumLunas($Month, $Year, $LastDate, $area_1, $area_2, $area_3, $area_4, $area_5);
        $NominalBelumLunas          = $this->M_BelumLunasUser->NominalBelumLunas($Month, $Year, $LastDate, $area_1, $area_2, $area_3, $area_4, $area_5);
            ...
            $row[] =
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu text-black" style="background-color:aqua;">
                        <a onclick="Payment(' . $dataCustomer['id_customer'] . ')"class="dropdown-item text-black"><i class="bi bi-receipt"></i> Lunasi Pelanggan</a>
                        <a onclick="KirimWA(' . $dataCustomer['id_customer'] . ')"class="dropdown-item text-black"><i class="bi bi-whatsapp"></i> Kirim Tagihan</a>
                    </div>
                </div>
                </div>';
            $data[] = $row;
