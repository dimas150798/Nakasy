...
class C_BelumLunas extends CI_Controller
{
    ...
    public function GetBelumLunas()
    {
        ...
        foreach ($result as $dataCustomer) {
            ...
            $Area_1 = $dataCustomer['kode_mikrotik'] == 'Kraksaan';
            $Area_2 = $dataCustomer['kode_mikrotik_paiton'] == 'Paiton';

            $Status_1 = $dataCustomer['disabled'] == 'true';
            $Status_2 = $dataCustomer['disabled_paiton'] == 'true';
