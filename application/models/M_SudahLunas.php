...
class M_SudahLunas extends CI_Model
{
    ...
    {
        $query   = $this->db->query("SELECT data_customer.nama_customer, data_customer.nama_paket, 
        data_customer.name_pppoe, DAY(data_customer.start_date) as tanggal, data_customer.deskripsi_customer, data_customer.nama_sales,
